...
export default function Authenticated({ auth, header, children }) {
    ...
    return (
        <div className="flex flex-col h-screen bg-gray-100">
            <nav className="bg-white border-b border-gray-100 h-[10%]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            <div className="shrink-0 flex items-center motion-safe:animate-spin">
                                <Link href="/">
                        ...
                        <div className="hidden sm:flex sm:items-center sm:ml-6 bg-white">
            ...
            <div className='h-[90%] w-full overflow-y-hidden mt-1'>
                {header !== undefined && (
                    <header className="bg-white shadow h-[10%]">
                        <div className="max-w-7xl mx-auto py-3 px-4 sm:px-6 lg:px-8">{header}</div>
                    </header>
                )}

                <main className={header !== undefined ? ' h-[90%] w-full': ' h-[100%] w-full'}>{children}</main>
            </div>
        </div>
    );
}
